...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Bird birdA = new Bird("Saddle-Billed Stork", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/220922121/1200",
                ...
                "Africa", "kenya", "east africa", "savanna", "ciconiiformes");
        ...
        Bird birdB = new Bird("Kori Bustard", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/218717931/1200",
                ...
                "Africa", "south africa", "south africa", "coastal", "otidiformes");
        Bird birdBA = new Bird("Arabian Bustard", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/244545511/1200",
                ...
                "Africa", "kenya", "east africa", "sahara", "otidiformes");
        ...
        Bird birdC = new Bird("Martial Eagle", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/218877601/1200",
                ...
                "Africa", "south africa", "south africa", "savanna", "accipitriformes");
        ...
        Bird birdD = new Bird("Southern Ground Hornbill", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/220890091/1200",
                ...
                "Africa", "kenya", "east africa", "savanna", "bucerotiformes");
        ...
        Bird birdE = new Bird("Pel's Fishing Owl", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/219362491/1200",
                ...
                "Africa", "gabon", "west africa", "coastal", "strigiformes");
        Bird birdEA = new Bird("Rufous Fishing-Owl", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/364507691/1200",
                ...
                "Africa", "guinea", "west africa", "coastal", "strigiformes");
        ...
        Bird birdF = new Bird( "Lesser Flamingo", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/54167691/1200",
                ...
                "Africa", "madagascar", "island", "tropical", "phoenicopteriformes");
        ...
        Bird birdG = new Bird( "Red-Throated Bee-Eater", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/245593691/1200",
                ...
                "Africa", "guinea", "west africa", "sahara", "coraciiformes");
        Bird birdGA = new Bird( "Blue-headed Bee-Eater", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/250961761/1200",
                ...
                "Africa", "gabon", "west africa", "coastal", "coraciiformes");
        Bird birdGB = new Bird( "Black Bee-Eater", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/250959771/1200",
                ...
                "Africa", "guinea", "west africa", "coastal", "coraciiformes");
        ...
        Bird birdH = new Bird("African Emerald Cuckoo", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/184151961/1200",
                ...
                "Africa", "south africa", "south africa", "coastal", "cuculiformes");
        Bird birdHA = new Bird("Yellow-Throated Cuckoo", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/333421721/1200",
                ...
                "Africa", "guinea", "west africa", "coastal", "cuculiformes");
        ...
        Bird birdI = new Bird("Madagascar Pochard", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/191687411/1200",
                ...
                "Africa", "madagascar", "island", "tropical", "anseriformes");
        ...
        Destinations mad1 = new Destinations(2555.99, "Madagascar Nascar", "safari", "Madagascar", "Island", "tropical", "/images/dest (5).jpg", "Learn the history of our plantations and our exotic fruits and vegetables. After this 5 hours safari, you will learn everything you need to know to start your own plantation and the history of Madagascar. This safari will take you in deep Madagascar and view wildlife right in front of your eyes. This requires the services of a specialist guide and driver. Your are going to be in the safe hands of our specialist guide and drive. At the end, we will be receiving you with a buffet created with our produce! Enjoy this unique experience!", africaTag, safariTag, tropicalTag);
        Destinations mad2 = new Destinations(2444.99, "Madagascar Madness", "boat", "Madagascar", "Island", "coastal", "/images/dest (6).jpg", "Enjoy your days on this beautiful, breezy, calm yacht. Escape your responsibilities for one week and enjoy the private beach and luxury yacht with breakfast and lunch included. You will be able to enjoy the marine wildlife, see our dolphin friends and enjoy the view of our birds in this area. On the third day of the week you will learn to snorkel with our expert instructor and see the beautiful marine wildlife. After your 4 hours class you will return to your room, greeted with fresh fruits.", africaTag, oceanTag);
        ...
        Destinations alge1 = new Destinations(3333.99, "Algeria Pizzaria", "romantic", "Algeria", "North", "mountain", "/images/dest (10).jpg", "The best pizza in the whole world with the best view! We make this pizza with fresh ingredients straight from our plantation. Indulge yourself on the fresh mozzarella and pasta sauce while watching the sunset and listening to live music. The beautiful calm waters, the colorful sunset, the aromatic scent of the area, this is one of the best experiences you will have! ", africaTag);
