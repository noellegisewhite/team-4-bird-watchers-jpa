...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Bird birdF = new Bird( "Lesser Flamingo", "https://th.bing.com/th?q=Flamingo+Fun&w=120&h=120&c=1&rs=1&qlt=90&cb=1&dpr=1.25&pid=InlineBlock&mkt=en-US&cc=US&setlang=en&adlt=moderate&t=1&mw=247",
        ...
        Bird birdH = new Bird("African Emerald Cuckoo", "https://th.bing.com/th?q=African+Emerald+Cuckoo+Feeding&w=120&h=120&c=1&rs=1&qlt=90&cb=1&dpr=1.25&pid=InlineBlock&mkt=en-US&cc=US&setlang=en&adlt=moderate&t=1&mw=247",
        ...
        Destinations alge1 = new Destinations(3333.99, "Algeria Pizzeria", "romantic", "Algeria", "North", "mountain", "/images/dest (10).jpg", "The best pizza in the whole world with the best view! We make this pizza with fresh ingredients straight from our plantation. Indulge yourself on the fresh mozzarella and pasta sauce while watching the sunset and listening to live music. The beautiful calm waters, the colorful sunset, the aromatic scent of the area, this is one of the best experiences you will have!  ");
        Destinations alge2 = new Destinations(3222.99, "Alpines of Algeria", "safari", "Algeria", "North", "mountain", "/images/dest (11).jpg", "Meet our bird friends on this calm safari, from our owls to our small birds, you will be able to see them in live action. Currently, we have 2 owlets that were born a month ago. We are keeping a close eye to them and making sure they are doing alright. On this 2 hours safari we will take you on a road not seen before, where you will see all types of wildlife. You will be on the safe hands of our expert driver. After this fulfilling event you will be greeted with a cocktail made from our finest bartenders.");
        Destinations alge3 = new Destinations(3111.99, "Algerian Mysteries", "safari", "Algeria", "North", "desert", "/images/dest (12).jpg", "Learn the history of the pyramid while on Algerian Mysteries Safari. After this 3 hours safari, you will know the ins and outs of this pyramid. A very unique experience, where you get to go to the tunnels and all the secret passageways. ");
